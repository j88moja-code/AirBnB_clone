...
* [8-index.html](https://github.com/j88moja-code/AirBnB_clone/blob/main/web_static/8-index.html) - an HTML page that displays a header, a footer, a filter box (dropdown list) and the result of the search.
...
- [100-index.html](https://github.com/j88moja-code/AirBnB_clone/blob/main/web_static/100-index.html) - an HTML page that displays a header, footer, a filters box with dropdown and results.
  ...
  - List of Reviews:
    _ tag `div`
    _ classname reviews \* margin top 40px
  - contains:
    - title:
      - tag `h2`
      - text Reviews
...
* [100-index.html]() - Improved the Places section by using Flexible boxes for all Place articles

* [101-index.html](https://github.com/j88moja-code/AirBnB_clone/blob/main/web_static/102-index.html) - Improved the page by adding responsive design to display correctly in mobile or small screens.

* [103-index.html]() - Improved the page by adding Accessibility support.
